...
export const updateProfileSchema = z.object({
  ...
  aboutPt: z.string().max(2000, 'A biografia pode ter no máximo 2000 caracteres.').nullable().optional(),
  aboutEn: z.string().max(2000, 'A biografia pode ter no máximo 2000 caracteres.').nullable().optional(),
